...
DEPEND="php_targets_php7-2? ( sys-libs/zlib ) php_targets_php7-3? ( sys-libs/zlib ) php_targets_php7-4? ( sys-libs/zlib )"
RDEPEND="${DEPEND}
...
src_install() {
	if use php_targets_php7-2 || uuse php_targets_php7-3 || use php_targets_php7-4 ; then
