...
PATCHES=(
    "${FILESDIR}"/000-032cff38c24d8359dc575423a94d19b6ad8bf848.patch
    "${FILESDIR}"/001-5a8549e68225070d0b79cbbb9c5f791e103685e7.patch
    "${FILESDIR}"/002-661bfc3d0e1b7756db59d00d86e316f694cae3c6.patch
    "${FILESDIR}"/003-eaf650083924a697cde3379703984c5e7a5ebd41.patch
	"${FILESDIR}"/004-8d09dc21dc913d1540d07d1019a51c430317eae1.patch
	"${FILESDIR}"/005-41dc8432f87622145390dc1b1467a5ee14ba184c.patch
	"${FILESDIR}"/006-d4376302377e4f51f43a183c2c91d929b27e1ae3.patch
	"${FILESDIR}"/007-3d574a587dc3704e93bcd29b16d54d96069667b4.patch
	"${FILESDIR}"/008-4fb65f421b4d650711e5d8b9dbcbf4bf589d26cc.patch
)
